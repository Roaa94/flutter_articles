...
class DummyArticles {
  static const Article exampleIndexArticle1 = Article(
    id: 1028679,
    title: 'Flutter CLI Cheat Sheet',
    description: 'This is a cheat sheet for the most useful commands you will need when developing a flutter app.      ...',
  ...
  static const Map<String, dynamic> rawExampleIndexArticle1 = {
    'id': 1028679,
    'title': 'Flutter CLI Cheat Sheet',
    'description': 'This is a cheat sheet for the most useful commands you will need when developing a flutter app.      ...',
  ...
  static const Article exampleIndexArticle2 = Article(
    id: 990934,
    title: 'The Grammar of Graphics in Flutter Charts',
    description: 'The new version of Flutter visualization library Graphic optimized its declarative specification...',
    readablePublishDate: 'Feb 16',
    url: 'https://dev.to/entronad/the-grammar-of-graphics-in-flutter-charts-3fhj',
    commentsCount: 0,
  ...
  static const List<Map<String, dynamic>> rawArticlesIndexResponse = [
    {
      "id": 1028679,
      "title": "Flutter CLI Cheat Sheet",
      "description": "This is a cheat sheet for the most useful commands you will need when developing a flutter app.      ...",
  ...
  static final List<Article> articlesIndexResponse = List<Article>.from(
    rawArticlesIndexResponse.map((x) => Article.fromJson(x)),
  );

  static const List<Map<String, dynamic>> rawAuthorArticlesResponse = [
    {
      "id": 1011954,
  ...
  static final List<Article> authorArticlesResponse = List<Article>.from(
    rawAuthorArticlesResponse.map((x) => Article.fromJson(x)),
  );

  static const Map<String, dynamic> rawArticleDetails = {
    "id": 1027874,
  ...
  static final Article articleDetails = Article.fromJson(rawArticleDetails);
}
